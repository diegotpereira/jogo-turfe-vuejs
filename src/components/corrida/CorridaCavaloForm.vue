<template>
    <div class="corrida__cavalo-nome">
        <h2 class="corrida__titulo">Cavalos Nomes</h2>
        <ol class="corrida__lista">
            <li class="corrida__lista-item largada-marca" v-for="cavalo in corridaLoja.cavalos" :key="cavalo.id">
